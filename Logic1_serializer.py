"""
Logic1_serializer.py — CAESAR II .CII serializer for Logic 1.
Ported from P1 serializer.py. No logger import needed.
"""
import pydantic
import math
        ...
        if "coords" in data and len(data["coords"]) > 0:
            ...
            for c in data["coords"]:
                if "raw_line" in c:
                    ...
                    self._add_line(f"  {c['node']:13d}{c['x']:13.4f}{c['y']:13.4f}{c['z']:13.4f}")
